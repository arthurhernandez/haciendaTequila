    ...
    <div className="min-h-screen bg-parchment pt-20 pb-12">
      <main className="max-w-4xl mx-auto px-6">
        ...
        <div className="mt-16 bg-brand-green text-parchment p-12 rounded-3xl text-center shadow-2xl relative overflow-hidden">
           ...
           <a href="tel:7089294378" className="bg-brand-red hover:bg-brand-red/90 text-white px-10 py-4 rounded-full font-bold uppercase tracking-widest transition-all inline-block shadow-lg">
             Call to Reserve
           </a>
        </div>
      </main>
